...
$(document).ready(function() {
    ...
    $('#miTabla').DataTable({
        ...
        buttons: [
        {
            ...
            exportOptions: {
                columns: [0,1,2,3] // Especifica las columnas a exportar (excluye la columna de opciones)
            },
    ...
    $(".eliminar").click(function() {
        ...
        $("#confirmar-eliminar").attr("data-id", elementoId);
    ...
    $("#confirmar-eliminar").click(function() {
        var elementoId = $(this).data("id");
        $.ajax({
            url: "/workspace/orden_prod/eliminar/" + elementoId,
            type: "POST",
            data: {
